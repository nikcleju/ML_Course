...
% ===========================================================
% Part 2: Implementing Backpropogation without Regularization
% ===========================================================  
% BP USING FOR LOOP - NOT EFFICIENT
% for t=1:m
...
% Vectorized implementation of BP
% Here X is including 1 column at begining
A1 = X; % 5000 x 401
...
Z3 = A2 * Theta2';  % m x num_labels == 5000 x 10
A3 = sigmoid(Z3); % m x num_labels == 5000 x 10 (h_x = a3; % m x num_labels == 5000 x 10)
