...
- Reset the overlap threhsold to 0.5, and set the score threshold to 0.02, and run it on the `Richarlison.jpg` image. What happens? What does this threshold do?
